...
create table patients(
   ...
   patient_location_lang varchar(28)  not null,
   patient_location_lat varchar(28)  not null,
   patient_name varchar(86) not null,
   patient_need varchar(126) not null,
   patient_time TIMESTAMP not null,
   patient_phonenumber varchar(20) not null,
   patient_is_active boolean default false not null,
   patient_is_deleted boolean default false not null,
